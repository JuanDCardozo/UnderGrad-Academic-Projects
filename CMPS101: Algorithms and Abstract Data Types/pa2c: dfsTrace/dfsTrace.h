...
/* Manipulation function.
 * Preconditions: adjVertices is not edgeNil.
 * Postconditions: None
 */
void dfsSweepEdge(int size, EdgeList* adjVertices,int* color, int* dtime, int* ftime, int* parent);

/* Manipulation function.
 * Preconditions: adjVertices is not edgeNil.
 * Postconditions: None
 */
void dfsTraceEdge(int v, EdgeList* adjVertices,int* color, int* dtime, int* ftime, int* parent, int time);
