...
static const yytype_uint8 yyrline[] =
{
      ...
      60,    67,    69,    73,    74,    77,    78,    79,    80,    81,
      84,    90,    97,   103,   112,   113,   117,   119,   122,   125,
     130,   131,   134,   135,   136,   137,   138,   139,   141,   143,
     149,   154,   158,   166,   169,   173,   174,   175,   176,   177,
     178,   179,   180,   181,   182,   183,   184,   185,   187,   189,
     190,   191,   192,   193,   194,   198,   203,   208,   214,   219,
     223,   228,   232,   233,   239,   246,   247,   248,   249
};
#endif
...
/* Line 1792 of yacc.c  */
#line 58 "parser.y"
    { (yyval) = (yyvsp[(1) - (4)])->adopt_sym_child((yyvsp[(2) - (4)]),TOK_TYPEID);
...
/* Line 1792 of yacc.c  */
#line 73 "parser.y"
    { (yyval) = (yyvsp[(2) - (3)])->adopt((yyvsp[(1) - (3)])); (yyval) = (yyvsp[(2) - (3)])->adopt_sym_child((yyvsp[(3) - (3)]), TOK_FIELD); }
    break;

  case 14:
/* Line 1792 of yacc.c  */
#line 74 "parser.y"
    { (yyval) = (yyvsp[(1) - (2)])->adopt_sym_child((yyvsp[(2) - (2)]),TOK_FIELD); }
    break;
...
#line 84 "parser.y"
    {
                                       ...
                                       (yyval) = as->adopt_sym_child((yyvsp[(2) - (4)]), TOK_PARAMLIST);
                                       destroy((yyvsp[(3) - (4)]), (yyvsp[(4) - (4)]));
                                      }
    break;
